    ...
    namespace com
    {
        namespace entry
        {
           ...
           /************************ useful in ValidateOption *********************/
                ...
                if (_result)
                {
                    switch (option->Type())
                    {
                        ...
                        case option::OptionType::IPv6Multicast:
                        {
                            ...
                            if (isAcknowledge())
                            {
                                _result = !ContainsCertainOption(option->Type());
                            }
                            else
                            {
                                _result = false;
            ...
            void EventgroupEntry::print() const noexcept
            {
                Entry::print();

                std::cout << "Entry Counter: " << static_cast<int>(Counter()) << std::endl;
                std::cout << "Entry EventgroupId: " << static_cast<int>(EventgroupId()) << std::endl;
            }
