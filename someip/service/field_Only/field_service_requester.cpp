#include "field_service_requester.h"
...
namespace ara
{
    namespace com
    {
        namespace someip
        {
            namespace sd
            {
                const std::string FieldServiceRequester::cAnyIpAddress("0.0.0.0");
                
                bool FieldServiceRequester::init(uint16_t &_port)
                {
                    std::string ip;
                    uint16_t port;
                    ...
                    fieldClient = new SockeKFieldClient( mServiceId,
                                                         mInstanceId,
                                                         mMajorVersion,
                                                         mMinorVersion,
                                                         mEventgroupId,
                ...
                FieldServiceRequester::FieldServiceRequester(
                    uint16_t serviceId,
                    uint16_t instanceId,
                                                ...
                                                mUdpSocket(cAnyIpAddress, port, nicIpAddress, multicastGroup)
                {
                    ...
                    auto _receiver{std::bind(&FieldServiceRequester::onReceive, this)};
                    ...
                    auto _sender{std::bind(&FieldServiceRequester::onSend, this)};
                ...
                void FieldServiceRequester::InvokeOfferingHandler(sd::SomeIpSdMessage &&message)
                {
                ...
                bool FieldServiceRequester::findService()
                {
                ...
                bool FieldServiceRequester::tryExtractOfferedEndpoint(
                ...
                bool FieldServiceRequester::TryGetTransportInfo(int duration, std::string &ipAddress,uint16_t &port)
                {
                    bool _result;
                ...
                bool FieldServiceRequester::TryGetTransportInfo(std::string &ipAddress,uint16_t &port)
                {
                    bool _result;
                ...
                bool FieldServiceRequester::findService(uint16_t &_port)
                {
                    // create SOMEIP/SD message
                    SomeIpSdMessage mFindServieMessage;
                ...
                void FieldServiceRequester::onReceive()
                {
                ...
                void FieldServiceRequester::onSend()
                {
                ...
                void FieldServiceRequester::Send(const SomeIpSdMessage &message)
                {
                ...
                AsyncBsdSocketLib::Poller* FieldServiceRequester::getPoller()
                {
                    return mPoller;
                }
