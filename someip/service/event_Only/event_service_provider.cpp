#include "event_service_provider.h"
        ...
        namespace someip
        {
            namespace sd
            {
                                            ...
                                            mUdpSocket(cAnyIpAddress, port, nicIpAddress, multicastGroup)
                {
                    ...
                    auto _receiver{std::bind(&EventServiceProvider::onReceive, this)};
                    ...
                    auto _sender{std::bind(&EventServiceProvider::onSend, this)};
                ...
                void EventServiceProvider::offerService()
                {                    
                ...
                void EventServiceProvider::stopService()
                {
                     // make SOMEIP/SD message
                ...
                void EventServiceProvider::onReceive()
                {
                ...
                void EventServiceProvider::onSend()
                {
                ...
                void EventServiceProvider::Send(const SomeIpSdMessage &message)
                {
                ...
                AsyncBsdSocketLib::Poller* EventServiceProvider::getPoller()
                {
                    return mPoller;
                }
