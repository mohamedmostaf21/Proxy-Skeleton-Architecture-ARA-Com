        ...
        {    
            ...
            class SwNameVersionProxy
            {
                public:
                    ...
                    SwNameVersionProxy (HandleType &handle);
                    ...
                    SwNameVersionProxy(const SwNameVersionProxy &other) = delete;
                    SwNameVersionProxy& operator=(const SwNameVersionProxy &other) = delete;
